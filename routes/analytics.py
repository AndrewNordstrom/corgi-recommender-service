...
def get_interaction_analytics():
    ...
    formatted_by_type = [
        ...
        for row in interactions_by_type
    ]
    ...
    # Format top posts
    formatted_top_posts = [
        {"post_id": row[0], "total_interactions": row[1]}
        for row in top_posts
    ]
    
    # Format top users (pseudonymized)
    formatted_top_users = [
        {"user_alias": row[0], "total_interactions": row[1]}
...
def get_post_analytics():
    ...
    formatted_by_type = [
        ...
        for row in posts_by_type
    ]
    
    formatted_top_authors = [
        {"author_id": row[0], "post_count": row[1]}
