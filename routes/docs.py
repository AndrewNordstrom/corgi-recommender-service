...
import json
import logging
from flask import Blueprint, jsonify, current_app, send_from_directory, render_template_string, request, redirect
...
SWAGGER_UI_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'swagger-ui')
