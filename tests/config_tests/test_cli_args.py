...
class TestServerArgParsing(unittest.TestCase):
    ...
    def test_port_override(self, mock_parse_args):
        ...
        mock_parse_args.return_value = argparse.Namespace(
            host=None, port=9090, no_https=False, force_http=False, cert=None, key=None
        )
        args = server_parse_args()
    ...
    def test_no_https_flag(self, mock_parse_args):
        ...
        mock_parse_args.return_value = argparse.Namespace(
            host=None, port=None, no_https=True, force_http=False, cert=None, key=None
        )
        args = server_parse_args()
    ...
    def test_force_http_flag(self, mock_parse_args):
        ...
        mock_parse_args.return_value = argparse.Namespace(
            host=None, port=None, no_https=False, force_http=True, cert=None, key=None
        )
        args = server_parse_args()
