...
def test_update_privacy_settings_success(
    mock_get_db, mock_update_privacy, client, mock_db_conn
):
    ...
    # Test data
    test_data = {"user_id": "user123", "tracking_level": "none"}
...
@patch("routes.privacy.update_user_privacy_level")
@patch("routes.privacy.get_db_connection")
def test_update_privacy_settings_invalid_level(
    mock_get_db, mock_update_privacy, client
):
    """Test update with invalid privacy level."""
    # Test data with invalid tracking_level
    test_data = {"user_id": "user123", "tracking_level": "invalid_level"}
...
@patch("routes.privacy.update_user_privacy_level")
@patch("routes.privacy.get_db_connection")
def test_update_privacy_settings_missing_fields(
    mock_get_db, mock_update_privacy, client
):
